      ...
      <nav className="fixed top-0 w-full z-50 border-b border-slate-800/50 bg-slate-950/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">SOPHIA</span>
          </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-sm text-blue-400 mb-8">
            ...
            SOPHIA — Self-Optimizing Predictive Hub & Intelligent Automation
          </div>
          <p className="text-lg font-semibold text-blue-400 mb-4">Meet SOPHIA</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold">Launch & SOPHIA Optimizes</h3>
                </div>
                <p className="text-slate-400 mb-6 leading-relaxed">
                  ...
                  Then SOPHIA's optimization engine takes over.
                </p>
                <ul className="space-y-3">
                  {[
              ...
              <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-green-400 font-medium">SOPHIA Active</span>
                </div>
                <div className="space-y-3">
                  {[
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Target, title: "Dynamic Landing Pages", desc: "Server-side A/B tested pages that auto-optimize. SOPHIA's optimization engine swaps headlines, CTAs, and layouts based on performance." },
              ...
              { icon: RefreshCw, title: "SOPHIA Optimization Engine", desc: "Monitors every funnel stage every 30 minutes. Detects drops, diagnoses root causes, and fixes issues automatically." },
              { icon: Brain, title: "SOPHIA Intelligence", desc: "When something breaks, SOPHIA analyzes the data, identifies the likely cause, and recommends or executes the right fix." },
